...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
# Modified GitHub Repo: https://github.com/angrez007/ihacker                      #
...
rhel5 ()	{
	...
	case $vsysarch in
			32) # 32 bit Squid configuration
					wget -O /etc/squid/squid.conf https://raw.githubusercontent.com/angrez007/ihacker/main/spi-rhel5632.conf --no-check-certificate;;
			64) # 64 bit Squid configuration
					wget -O /etc/squid/squid.conf https://raw.githubusercontent.com/angrez007/ihacker/main/spi-rhel5664.conf --no-check-certificate;;
	esac
...
rhel7 ()	{
	...
	wget -O /etc/squid/squid.conf https://raw.githubusercontent.com/angrez007/ihacker/main/spi-rhel7.conf --no-check-certificate
	# Creating empty blacklist.acl file for further blacklisting entries
	touch /etc/squid/blacklist.acl
	# Restarting Squid and enabling its service
